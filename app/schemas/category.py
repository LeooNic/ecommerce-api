...
class CategoryBase(BaseModel):
    ...
    slug: str = Field(..., min_length=1, max_length=120, description="URL-friendly category identifier")
...
class CategoryUpdate(BaseModel):
    ...
    description: Optional[str] = Field(None, description="Category description")
    slug: Optional[str] = Field(None, min_length=1, max_length=120, description="URL-friendly category identifier")
