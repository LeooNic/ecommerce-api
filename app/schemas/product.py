...
class ProductBase(BaseModel):
    ...
    slug: str = Field(..., min_length=1, max_length=220, description="URL-friendly product identifier")
    ...
    low_stock_threshold: int = Field(10, ge=0, description="Low stock warning threshold")
    weight: Optional[Decimal] = Field(None, description="Product weight in kg")
    dimensions: Optional[str] = Field(None, max_length=100, description="Product dimensions (LxWxH cm)")
    ...
    requires_shipping: bool = Field(True, description="Whether the product requires shipping")
...
class ProductUpdate(BaseModel):
    ...
    description: Optional[str] = Field(None, description="Product description")
    slug: Optional[str] = Field(None, min_length=1, max_length=220, description="URL-friendly product identifier")
    ...
    requires_shipping: Optional[bool] = Field(None, description="Whether the product requires shipping")
    meta_title: Optional[str] = Field(None, max_length=255, description="SEO meta title")
    meta_description: Optional[str] = Field(None, description="SEO meta description")
    category_id: Optional[int] = Field(None, description="Category ID")
